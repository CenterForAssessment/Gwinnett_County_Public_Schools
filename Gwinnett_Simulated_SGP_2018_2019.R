...
load("/Users/avi/Dropbox (SGP)/Github_Repos/Projects/Gwinnett_County_Public_Schools/SGP_CONFIG/2018_2019/GCPS.config.rda")
...
Gwinnett_SGP <- analyzeSGP(
  ...
  parallel.config = list(BACKEND="FOREACH", TYPE="doParallel", WORKERS=list(TAUS=8, SIMEX=8))) # Added SIMEX argument
